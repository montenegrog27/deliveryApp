...
const bricolage = localFont({
  src: "../../public/font/BricolageGrotesque-ExtraBold.ttf",
});
const bricolageLight = localFont({
  src: "../../public/font/BricolageGrotesque-ExtraLight.ttf",
});
      ...
      <AnimatePresence mode="wait">
        {step === 0 && (
          <motion.div key="experiencia" className="space-y-6 text-center">
            <h2 className={`${bricolage.className} text-xl sm:text-2xl`}>
        ...
        {step === 3 && (
          <motion.div key="comentario" className="space-y-4">
            <label
              className={`${bricolageLight.className} text-base sm:text-lg`}
            >
